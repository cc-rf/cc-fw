...
#define UMM_MALLOC_CFG_HEAP_SIZE configTOTAL_HEAP_SIZE
...
#define UMM_CRITICAL_EXIT()         (void) xTaskResumeAll();
...
#  define UMM_HEAP_CORRUPTION_CB() board_die( "Heap Corruption!" )
#else
