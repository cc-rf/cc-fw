...
void pit_set_period(pit_t pit, pit_tick_t period) __fast_code;
pit_tick_t pit_get_period(pit_t pit) __fast_code;
pit_tick_t pit_get_current(pit_t pit) __fast_code;
pit_tick_t pit_get_elapsed(pit_t pit) __fast_code;
bool pit_started(pit_t pit) __fast_code;

void pit_start(pit_t pit) __fast_code;
void pit_stop(pit_t pit) __fast_code;
void pit_restart(pit_t pit) __fast_code;
